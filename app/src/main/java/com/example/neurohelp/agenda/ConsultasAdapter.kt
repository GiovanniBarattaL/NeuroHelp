...
class ConsultasAdapter(
    ...
    override fun onBindViewHolder(
        ...
        when (val item = getItem(position)) {
            ...
            is ItemAgenda.Secao ->
                (holder as SecaoViewHolder).vincular(item)
    ...
    class SecaoViewHolder(
        itemView: View
    ) : RecyclerView.ViewHolder(itemView) {

        private val txtSecao: TextView =
            itemView.findViewById(R.id.txtSecao)
    ...
    class ConsultaViewHolder(
        ...
        private val viewBarraCor: View =
            itemView.findViewById(R.id.viewBarraCor)

        private val imgIcone: ImageView =
            itemView.findViewById(R.id.imgIconeEspecialidade)

        private val txtTitulo: TextView =
            itemView.findViewById(R.id.txtTituloConsulta)

        private val txtProfissional: TextView =
            itemView.findViewById(R.id.txtProfissional)

        private val txtHorario: TextView =
            itemView.findViewById(R.id.txtHorario)

        private val imgModalidade: ImageView =
            itemView.findViewById(R.id.imgModalidade)

        private val txtModalidade: TextView =
            itemView.findViewById(R.id.txtModalidade)

        private val btnDetalhes: MaterialButton =
            itemView.findViewById(R.id.btnDetalhes)
        ...
        fun vincular(
            ...
            txtTitulo.text = contexto.getString(
                ...
                contexto.getString(
                    consulta.especialidade.nomeRes
                )
            )
            ...
            imgModalidade.setImageResource(
                when (consulta.modalidade) {
                    ...
                    ModalidadeConsulta.ONLINE ->
                        R.drawable.ic_online_agenda

                    ModalidadeConsulta.PRESENCIAL ->
                        R.drawable.ic_local_agenda
                }
            )
            ...
            // SOMENTE O BOTÃO "DETALHES" É CLICÁVEL
            btnDetalhes.setOnClickListener {
                aoClicarDetalhes(consulta)
            }
        }
    }

    private object Diff :
        DiffUtil.ItemCallback<ItemAgenda>() {
        ...
        override fun areItemsTheSame(
            ...
            oldItem is ItemAgenda.Secao &&
                    newItem is ItemAgenda.Secao ->
                oldItem.titulo == newItem.titulo

            oldItem is ItemAgenda.Item &&
                    newItem is ItemAgenda.Item ->
                oldItem.consulta.id ==
                        newItem.consulta.id
